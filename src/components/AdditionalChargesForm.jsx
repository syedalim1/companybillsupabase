  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 transition-shadow hover:shadow-md">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div>
           <label className="block text-xs font-medium   mb-1">Freight</label>
           <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-2 sm:pl-3 flex items-center   text-sm">₹</span>
                <input
                    type="number"
                    ...
                    placeholder="0"
                    className="w-full pl-6 sm:pl-8 p-2 sm:p-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all text-right font-medium text-sm text-text-title"
                />
            </div>
        </div>
        <div>
        ...
        <div>
           <label className="block text-xs font-medium   mb-1">Packing</label>
           <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-2 sm:pl-3 flex items-center   text-sm">₹</span>
                <input
                    type="number"
