...
const AdditionalChargesForm = ({ invoiceData, handleInputChange }) => {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 transition-shadow hover:shadow-md">
       <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 sm:mb-6 flex items-center gap-2 pb-4 border-b border-gray-100">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div>
           <label className="block text-xs font-medium text-gray-500 mb-1">Freight</label>
           <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-2 sm:pl-3 flex items-center text-gray-400 text-sm">₹</span>
                <input
                    type="number"
                    ...
                    placeholder="0"
                    className="w-full pl-6 sm:pl-8 p-2 sm:p-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-right font-medium text-sm"
                />
            </div>
        </div>
        <div>
      ...
      <div className="border-t border-gray-100 pt-4 sm:pt-6 space-y-4">
        {/* Discount Row */}
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
          <label className="text-xs font-bold text-red-500 sm:w-32">Apply Discount</label>
          <div className="relative flex-1">
            <input
              ...
              placeholder="0"
              className="w-full p-2 sm:p-3 bg-red-50 border border-red-100 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-red-500 transition-all text-right font-medium text-red-600 text-sm"
            />
        ...
        <div className="bg-gray-50 p-3 sm:p-4 rounded-xl border border-gray-200">
          <label className="block text-xs font-bold text-gray-700 mb-2">Advance / Less Amount</label>
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="flex-1 p-2 sm:p-3 bg-white border border-gray-200 rounded-lg text-sm"
            />
            <div className="relative w-full sm:w-36">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-8 p-2 sm:p-3 bg-white border border-gray-200 rounded-lg text-right font-bold text-sm"
              />
            </div>
          </div>
        </div>
